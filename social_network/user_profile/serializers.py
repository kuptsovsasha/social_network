...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    def to_internal_value(self, data):
        ...
        """
        auth_user_data = {key: value for key, value in data.items() if key not in "profile_image"}

        user_sz = UserSerializer(instance=self.instance.user, data=auth_user_data, partial=True)
